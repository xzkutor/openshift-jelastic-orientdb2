...
[ -f "$ORIENTDB_HOME"/lib/orientdb-etl-2.2.0.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
$JAVA -server $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS -Dfile.encoding=utf-8 -Dorientdb.build.number="develop@r79d281140b01c0bc3b566a46a64f1573cb359783; 2016-05-18 14:14:32+0000" -cp "$ORIENTDB_HOME/lib/*" com.orientechnologies.orient.etl.OETLProcessor $*
