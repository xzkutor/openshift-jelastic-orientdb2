...
[ -f "$ORIENTDB_HOME"/lib/orientdb-etl-2.1.9.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
$JAVA -server $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS -Dfile.encoding=utf-8 -Dorientdb.build.number="2.1.x@r${buildNumber}; 2016-01-07 10:51:24+0000" -cp "$ORIENTDB_HOME/lib/*" com.orientechnologies.orient.etl.OETLProcessor $*
